...
<template>
  <Card>
    ...
    <div>
      ...
      <br />
      <Alert type="error" v-if="form_meta.name==='实践课评价用表第2版'">
        <strong>注：</strong>
        <br />（1）教师授课情况“总体评价”为“非常满意”，需同时满足三个条件：①7个项目中，评价等级为“非常满意”的项目数≥5；②标★项目的评价等级必须为非常满意；③没有项目的评价等级为“存在不足”及以下。
        <br />（2）教师授课情况“总体评价”为“存在明显不足”，需满足的条件：7个项目中，评价等级为“存在明显不足”的项目数≥3。
      </Alert>
      <Alert type="error" v-if="form_meta.name==='理论课评价用表第2版'">
        <strong>注：</strong>
        <br />（1）教师授课情况“总体评价”为“非常满意”，需同时满足三个条件：①6个项目中，评价等级为“非常满意”的项目数≥4；②标★项目的评价等级必须为非常满意；③没有项目的评价等级为“存在不足”及以下。
        <br />（2）教师授课情况“总体评价”为“存在明显不足”，需满足的条件：6个项目中，评价等级为“存在明显不足”的项目数≥3。
      </Alert>
      <Alert type="error" v-if="form_meta.name==='体育课评价用表第2版'">
        <strong>注：</strong>
        <br />（1）教师授课情况“总体评价”为“非常满意”，需满足如下条件：①8个项目中，评价等级为“非常满意”的项目数≥6；②标★项目的评价等级必须为非常满意；③没有项目的评价等级为“存在不足”及以下。
        <br />（2）教师授课情况“总体评价”为“非常满意”为“存在明显不足”，需满足如下条件：8个项目中，评价等级为“存在明显不足”的项目数≥3。
      </Alert>
      <br />
